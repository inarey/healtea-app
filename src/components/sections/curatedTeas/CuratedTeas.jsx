...
const CuratedTeas = () => {
  return (
    <div className='flex flex-row max-w-full px-24 py-10 border-t-8 border-b-8 border-brand-500 dark:bg-gray-950 '>
      <div className='flex flex-col justify-center items-start w-1/3 '>
      <h2 className='text-2xl font-bold text-brand-900 dark:text-gray-200 mb-4 w-3/4'>Curated Teas for Your Everyday Ritual</h2>
      <Link
          to="/shop"
